...
En un post anterior estuve presentando la resolucion de los retos basicos de Atenea, en esta segunda entrega continuare con algunas retos mas, y quiza nos alcance para realizar una tercera entrega.
...
Dentro de la explicación y las referencias que nos dan en el reto, podemos ver que hay una URL con un script en Python que nos calcula la entropía, así que lo tomaremos como base y haremos algunas modificaciones para que recorra el directorio, compare la entropía de cada fichero y nos muestre solo el que tenga la mayor.  Tambien que ese nombre lo convierta en el formato de la flag de la plataforma.
